...
class BookReviewAPITestCase(APITestCase):
    def setUp(self):
        self.user = CustomUser.objects.create(username='jahongir', first_name='Jakhongir')
    ...
    def test_book_review_detail(self):
        ...
        self.assertEqual(response.data['book']['descriptions'], 'Description1')
    ...
    def test_book_review_list(self):
        user_two = CustomUser.objects.create(username='someone', first_name='Someone')
        book = Book.objects.create(title='Book1', descriptions='Description1', isbn='123123')
        br = BookReview.objects.create(book=book, user=self.user, stars_given = 5, comment='Very good book')
        br_two = BookReview.objects.create(book=book, user=user_two, stars_given = 4, comment='not good')
